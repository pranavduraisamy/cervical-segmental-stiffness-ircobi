...
::: notes
Hi, Im pranav, recently completed my bachelors in mech. this study is a result of my bachelors pjt thesis. its mainly concentrated on sex diff in sub axial c spine segments
:::
...
::: notes
To give a broader overview of avl data relevant to this study. First we have wheeldon study, there were both male & female specimens but in the analysis everything were clubbed together. So we dunno the diff bw male & female. Then we have this study by winkelstein but all the specimens in this study were male. Finalluy we have these studies by nightingale, where the data for male & female were reported separately & its available openly in NHTSA database.
:::
...
::: notes
the exp setup was same for both the nightingale studies. so it can be made as a comparable study which was not done by the original author. c spine segments were cut from unembalmed pmhs and tested in flexibility & failure tests
:::
...
::: notes
This slide shows no of specimens tested. just for the moment, consider c3c4 there are 11 specimens for female but there is only 1 specimen for its very adjacent c4c5 . this is because of the segmentation of fsus. same trend follows for male too but different segments. bayesian methodology is more apt for these kind of data.
:::
...
::: notes
From the line of best fit, you would find the parameters a & b as consts. another approach is to do bayesian linear reg. where these parameters are estimated as probability distributions
:::
...
::: notes
we can see the dist of coeff for loading are similar in ext & flex. they are literally on top of each other. but if you look at this, the coeff for multilevel loading given sex in Ext, male & female are similar. but in flexion, we cans ee a clear difference between male & female.
:::
